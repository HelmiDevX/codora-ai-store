...
export const StatsCards: React.FC<StatsCardsProps> = ({ orders = [] }) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 w-full">
      {/* Metric Cards: 1 col on mobile, 2 cols on sm, 3 cols on lg */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 w-full">
        {/* Metric 1: Total Revenue */}
        <div className="p-4 sm:p-5 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl space-y-2.5 sm:space-y-3 relative overflow-hidden group hover:border-emerald-500/30 transition-all">
          ...
          <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-emerald-400 font-semibold pt-1 border-t border-slate-800/80">
        ...
        <div className="p-4 sm:p-5 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl space-y-2.5 sm:space-y-3 relative overflow-hidden group hover:border-indigo-500/30 transition-all">
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-indigo-300 font-semibold pt-1 border-t border-slate-800/80">
        ...
        <div className="p-4 sm:p-5 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl space-y-2.5 sm:space-y-3 relative overflow-hidden group hover:border-purple-500/30 transition-all sm:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-[11px] sm:text-xs text-purple-300 font-semibold pt-1 border-t border-slate-800/80">
      ...
      <div className="p-4 sm:p-5 rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl space-y-3 sm:space-y-4 w-full">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="text-xs font-bold text-slate-200">
              توزيع المبيعات حسب القنوات الترويجية (Sales Channels)
            </h4>
            <p className="text-[10px] sm:text-[11px] text-slate-400">
              نسبة التحويلات والطلبات المستلمة عبر المنصات
            </p>
          </div>
          <span className="text-xs font-mono font-bold text-indigo-400">100%</span>
        </div>
